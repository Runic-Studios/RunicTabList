...
public class TabElement {
    ...
    /**
     * A method that returns the game profile of the fake player
     *
     * @return the game profile of the fake player
     */
    @NotNull
    ...
    /**
     * A method that rebuilds the profile
     */
    private void reloadProfile() {
        this.profile = new WrappedGameProfile(this.uuid, this.text);
        this.profile.getProperties().put("textures", new WrappedSignedProperty("textures", this.skin.getValue(), this.skin.getSignature()));
    }
